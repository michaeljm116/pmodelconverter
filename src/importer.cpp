...
bool PImporter::WritePEModel(PrincipiaModel& m, std::string fn) {
...
bool PImporter::WriteSkeleton(PrincipiaSkeleton& s, std::string fn) {
...
PrincipiaModel PImporter::ReadPEModel(const char* pFile){
	PrincipiaModel mod;
	std::fstream binaryio;
...
bool PImporter::DoTheImportThing(const std::string& pFile, PrincipiaModel& m, PrincipiaSkeleton& s, bool triangulate)
{
	tempDataStruct tds;
...
bool PImporter::LoadDirectory(std::string directory, bool triangulate)
{
...
bool PImporter::LoadBones(const aiScene* scene, tempDataStruct& tds) {
